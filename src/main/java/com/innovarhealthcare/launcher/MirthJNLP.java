...
public class MirthJNLP {
    ...
    private ExtensionInfo parseExtensionJnlp(String extJnlpUrl, String mirthVersion) {
        ...
        try {
            ...
            // Extract extension name from URL (e.g., pdfviewer from
            // "https://localhost:8443/webstart/extensions/pdfviewer.jnlp")
    ...
    private void downloadAndLaunch(String jnlpUrl, List<String> coreJars, String mirthVersion,
...
//        command.add(
//                "-Djava.library.path=C:\\Program Files\\Mirth Connect Administrator Launcher\\mcadministrator\\windows-x64\\openjfx\\11");
        command.add("-cp");
...
//                if (line.contains("href") && line.contains("/") && !line.contains("..") && !line.contains("css")
//                        && !line.contains("js")) {
//                    int startIndex = line.indexOf("href=\"") + 6;
//                    int endIndex = line.indexOf("/", startIndex);
//                    if (endIndex > startIndex) {
